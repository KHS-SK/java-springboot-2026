...
public class BoardService {
    ...
    // Autowired를 쓰던지, 아니면 생성자를 만들던지 (@RequiredArgsConstructor은 아래의 파라미터 생성자를 자동으로 만들어주는 역할)
    ...
    public boolean putBoardOne(Board board, String title, String content) {
        try {
            ...
            // PK(Primary Key) bno가 있으면 save 실행 시 UPDATE 쿼리 실행 
